...
class Game:
    ...
    def show_start_screen(self):
        ...
        self.draw_text("Стрелки - перемещение, пробел - прыжок", 22, WHITE, WIDTH / 2, HEIGHT / 2)
        self.draw_text("Нажмите клавишу, чтобы играть", 22, WHITE, WIDTH / 2, HEIGHT * 3 / 4)
    ...
    def show_go_screen(self):
        ...
        self.draw_text("Счет: " + str(self.score), 22, WHITE, WIDTH / 2, HEIGHT / 2)
        self.draw_text("Нажмите клавишу, чтобы сыграть снова", 22, WHITE, WIDTH / 2, HEIGHT * 3 / 4)
